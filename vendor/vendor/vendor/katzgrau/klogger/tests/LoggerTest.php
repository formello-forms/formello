...
class LoggerTest extends \Formello\PHPUnit\Framework\TestCase
{
    private $logPath;
    private $logger;
    private $errLogger;
    public function setUp()
    {
        ...
        $this->errLogger = new Logger($this->logPath, LogLevel::ERROR, array('extension' => 'log', 'prefix' => 'error_', 'flushFrequency' => 1));
    }
    public function testImplementsPsr3LoggerInterface()
    {
        $this->assertInstanceOf('Formello\\Psr\\Log\\LoggerInterface', $this->logger);
    }
