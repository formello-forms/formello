...
abstract class Rule
{
     ...
     * @return void
     */
    public function setValidation(\Formello\Rakit\Validation\Validation $validation)
    {
     ...
     * @return void
     */
    public function setAttribute(\Formello\Rakit\Validation\Attribute $attribute)
    {
     ...
     */
    public function setParameters(array $params) : \Formello\Rakit\Validation\Rule
    {
     ...
     * @return \Rakit\Validation\Rule
     */
    public function setParameter(string $key, $value) : \Formello\Rakit\Validation\Rule
    {
     ...
     * @return \Rakit\Validation\Rule
     */
    public function message(string $message) : \Formello\Rakit\Validation\Rule
    {
     ...
     * @return \Rakit\Validation\Rule
     */
    public function setMessage(string $message) : \Formello\Rakit\Validation\Rule
    {
    ...
    protected function requireParameters(array $params)
    {
        foreach ($params as $param) {
            if (!isset($this->params[$param])) {
                $rule = $this->getKey();
                throw new \Formello\Rakit\Validation\MissingRequiredParameterException("Missing required parameter '{$param}' on rule '{$rule}'");
            }
        }
    }
}
