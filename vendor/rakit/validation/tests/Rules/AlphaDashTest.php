...
use Formello\Rakit\Validation\Rules\AlphaDash;
use Formello\PHPUnit\Framework\TestCase;
class AlphaDashTest extends \Formello\PHPUnit\Framework\TestCase
{
    public function setUp()
    {
        $this->rule = new \Formello\Rakit\Validation\Rules\AlphaDash();
    }
