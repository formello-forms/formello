...
use Formello\Rakit\Validation\Rules\Integer;
use Formello\PHPUnit\Framework\TestCase;
class IntegerTest extends \Formello\PHPUnit\Framework\TestCase
{
    public function setUp()
    {
        $this->rule = new \Formello\Rakit\Validation\Rules\Integer();
    }
