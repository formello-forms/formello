...
use Formello\Rakit\Validation\Rules\AlphaSpaces;
use Formello\PHPUnit\Framework\TestCase;
class AlphaSpacesTest extends \Formello\PHPUnit\Framework\TestCase
{
    public function setUp()
    {
        $this->rule = new \Formello\Rakit\Validation\Rules\AlphaSpaces();
    }
