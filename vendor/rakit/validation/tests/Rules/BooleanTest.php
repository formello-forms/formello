...
use Formello\Rakit\Validation\Rules\Boolean;
class BooleanTest extends \Formello\PHPUnit\Framework\TestCase
{
    public function setUp()
    {
        $this->rule = new \Formello\Rakit\Validation\Rules\Boolean();
    }
