...
use Formello\Rakit\Validation\Rules\Before;
use Formello\PHPUnit\Framework\TestCase;
use DateTime;
class BeforeTest extends \Formello\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $this->validator = new \Formello\Rakit\Validation\Rules\Before();
    }
    /**
    ...
    {
        $now = new \DateTime();
        return [[2016], [$now->format("Y-m-d")], [$now->format("Y-m-d h:i:s")], ["now"], ["tomorrow"], ["2 years ago"]];
    }
    /**
