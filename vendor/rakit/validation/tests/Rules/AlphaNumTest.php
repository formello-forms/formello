...
use Formello\Rakit\Validation\Rules\AlphaNum;
use Formello\PHPUnit\Framework\TestCase;
class AlphaNumTest extends \Formello\PHPUnit\Framework\TestCase
{
    public function setUp()
    {
        $this->rule = new \Formello\Rakit\Validation\Rules\AlphaNum();
    }
