...
use Formello\Rakit\Validation\Rules\Between;
use Formello\PHPUnit\Framework\TestCase;
class BetweenTest extends \Formello\PHPUnit\Framework\TestCase
{
    public function setUp()
    {
        $this->rule = new \Formello\Rakit\Validation\Rules\Between();
    }
    ...
    public function testUploadedFileValue()
    {
        ...
        $sampleFile = ['name' => \pathinfo(__FILE__, \PATHINFO_BASENAME), 'type' => 'text/plain', 'size' => $mb(2), 'tmp_name' => __FILE__, 'error' => 0];
