...
use Formello\Rakit\Validation\Rules\TypeArray;
use Formello\PHPUnit\Framework\TestCase;
class TypeArrayTest extends \Formello\PHPUnit\Framework\TestCase
{
    public function setUp()
    {
        $this->rule = new \Formello\Rakit\Validation\Rules\TypeArray();
    }
