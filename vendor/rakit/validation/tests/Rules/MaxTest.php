...
use Formello\Rakit\Validation\Rules\Max;
use Formello\PHPUnit\Framework\TestCase;
class MaxTest extends \Formello\PHPUnit\Framework\TestCase
{
    public function setUp()
    {
        $this->rule = new \Formello\Rakit\Validation\Rules\Max();
    }
    ...
    {
        $twoMega = 1024 * 1024 * 2;
        $sampleFile = ['name' => \pathinfo(__FILE__, \PATHINFO_BASENAME), 'type' => 'text/plain', 'size' => $twoMega, 'tmp_name' => __FILE__, 'error' => 0];
