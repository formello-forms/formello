...
namespace Formello\DrewM\MailChimp;
...
class MailChimp
{
    ...
    {
        return new \Formello\DrewM\MailChimp\Batch($this, $batch_id);
    }
    /**
    ...
    private function makeRequest($http_verb, $method, $args = array(), $timeout = self::TIMEOUT)
    {
        ...
        $httpHeader = array('Accept: application/vnd.api+json', 'Content-Type: application/vnd.api+json', 'Authorization: apikey ' . $this->api_key);
    ...
    private function formatResponse($response)
    {
        ...
        if (!empty($response['body'])) {
            return \json_decode($response['body'], \true);
        }
        return \false;
    }
    /**
