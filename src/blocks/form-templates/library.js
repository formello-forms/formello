...
function TemplatesModal ( props ) {
	...
	const showLoadingSpinner = loading || ! allTemplates || ! allTemplates.length;
										...
										<div>
											{ 'local' === tabType ? (
												<Fragment>
													...
													<a className="components-button is-button is-primary" href={ generateBlocksPro.templatesURL } target="_blank" rel="noopener noreferrer">{ __( 'Add New', 'formello' ) }</a>
												</Fragment>
											) : (
