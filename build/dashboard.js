...
function General(props) {
  ...
  const updateLicense = () => {
    ...
    _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_4___default()({
      ...
      if (!result.success || !result.response || !result.response.success) {
        showMessage('License ' + result.response.license, 'error', elementRef);
      }
    });
  };
...
function App() {
  ...
  const settings = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_6__.useSelect)(select => select('formello/data').getSettings());
