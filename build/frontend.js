...
/*!******************************!*\
  !*** ./src/frontend/form.js ***!
  \******************************/
/*! exports provided: Formello */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Formello", function() { return Formello; });
...
/* harmony import */ var _events_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./events.js */ "./src/frontend/events.js");





var Formello = /*#__PURE__*/function () {
  function Formello(element) {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, Formello);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Formello, [{
    key: "init",
    value: function init() {
      this.reCaptcha();
    }
    ...
    key: "submitForm",
    value: function submitForm(token) {
      this.showLoading();
      this.cleanMessage();
    ...
    value: function emitEvent(eventName) {
      ...
      _events_js__WEBPACK_IMPORTED_MODULE_3__["default"].trigger(eventName, [this.element]);
    }
  }, {
    key: "createRequestHandler",
    value: function createRequestHandler(formEl) {
      var parent = this;
      return function () {
        // are we done?
    ...
    value: function reCaptcha() {
      var recaptcha = this.element.dataset.recaptcha;
    ...
    value: function reCaptchaToken() {
      ...
      grecaptcha.ready(function () {
        grecaptcha.execute(formello.settings.reCaptcha.site_key, {
          ...
          _this.element.querySelector('.formello-g-recaptcha').value = token;
    ...
    key: "addMessage",
    value: function addMessage(message, errors) {
      var msg = this.element.querySelector('.formello-message');
    ...
    value: function showLoading() {
      var btn = this.element.querySelector('.wp-block-formello-button');
...
var validate = new formbouncerjs__WEBPACK_IMPORTED_MODULE_1___default.a('.wp-block-formello-form', {
  disableSubmit: true
});
document.addEventListener('DOMContentLoaded', function () {
  var forms = document.querySelectorAll('.wp-block-formello-form');
