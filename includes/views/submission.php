...
$submission_id = isset( $_GET['submission'] ) ? $_GET['submission'] : '';
?>

<h2><?php echo sprintf( __( 'Submission #%s', 'formello' ), $submission_id ); ?></h2>
...
<div class="wrap">
        ...
        <table class="formello-bordered">
            ...
            if( is_array( $submission->data ) ) {
                foreach( $submission->data as $field => $value ) {
                    ...
                    echo '<td>';
                    echo $this->formello_field_value($value);
                    echo '</td>';
                    echo '</tr>';
                }
            } ?>
    ...
    <div>
        ...
        <table class="formello-bordered">
            ...
            <tr>
                <th><?php _e( 'IP Address', 'formello' ); ?></th>
                <td><?php echo esc_html( $submission->ip_address ); ?></td>
            </tr>
            <?php } // end if ip_address ?>

            <tr>
                <th><?php _e( 'Referrer URL', 'formello' ); ?></th>
...
<div>
    <p><a href="<?php echo esc_attr( remove_query_arg( 'submission' ) ); ?>">&lsaquo; <?php _e( 'Back to submissions list', 'formello' ); ?></a></p>
</div>
