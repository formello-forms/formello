	...
	<div class="formello-addons">
		...
		<?php foreach ( $formello_addons['products'] as $formello_item ) : ?>
			<div class="addon">
				...
				<footer>
					<a  target="_blank" class="button" href="<?php echo esc_url( 'https://formello.net/downloads/' . $formello_item['info']['slug'] ); ?>" title="More about <?php echo esc_attr( $formello_item['info']['slug'] ); ?>">
						<?php echo esc_html( __( 'Get this Extension', 'formello' ) ); ?>
					</a>
				</footer>
			</div>
		<?php endforeach; ?>
